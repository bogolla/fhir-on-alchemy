...
# -*- coding: utf-8 -*-
#
#  FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit)
#  Date: 2016-03-22.
...
class ExplanationOfBenefit(domainresource.DomainResource):
    ...
    def __init__(self, created, disposition, identifier, organization,
                 originalRuleset, outcome, request, requestOrganization,
                 requestProvider, ruleset):
