...
# -*- coding: utf-8 -*-
#
#  FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/StructureDefinition)
#  Date: 2016-03-22.
...
class StructureDefinition(domainresource.DomainResource):
    ...
    contact = Column(primitives.StringField,
                     ForeignKey('StructureDefinitionContact.id'))
    """ Contact details of the publisher.
    ...
    differential = Column(primitives.StringField,
                          ForeignKey('StructureDefinitionDifferential.id'))
    """ Differential view of the structure.
    ...
    mapping = Column(primitives.StringField,
                     ForeignKey('StructureDefinitionMapping.id'))
    """ External specification that the content is mapped to.
    ...
    snapshot = Column(primitives.StringField,
                      ForeignKey('StructureDefinitionSnapshot.id'))
    """ Snapshot view of the structure.
    ...
    def __init__(self, abstract, base, code, constrainedType, contact, context,
                 contextType, copyright, date, description, differential,
                 display, experimental, fhirVersion, identifier, kind, mapping,
                 name, publisher, requirements, snapshot, status, url,
                 useContext, version,):
        """ Initialize all valid properties.
        """
