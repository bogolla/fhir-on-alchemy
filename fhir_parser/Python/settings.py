...
write_factory = True
tpl_factory_target = '../models/factory/fhirelementfactory.py'

# Whether and where to write unit tests
write_unittests = True
tpl_unittest_target_ptrn = '../models/unit_tests/{}_tests.py'     # a pattern to determine the output files for unit tests; the one placeholder will be the class name
